...
<div class="py-3">
    ...
    <div class="my-3 flex items-center font-semibold">
        ...
        <a href="create-coordinator.php" class="px-9 py-3 bg-[#8EA1E6] rounded-lg text-sm me-5">Coordinator</a>
...
<form class="font-semibold grid lg:grid-cols-4 grid-cols-2 gap-x-5">
    ...
    <div class="flex">
        <button type="submit" name="create_coord_btn" class="px-8 py-3 bg-[#8EA1E6] rounded-lg text-sm">Create</button>
    </div>
</form>
